...
class DeleteMedicationEntryUseCase(private val repository: MedicationRepository) {
    suspend operator fun invoke(entry: MedicationEntry) = repository.deleteMedicationEntry(entry)
}