...
class UpdateMedicationEntryUseCase(private val repository: MedicationRepository) {
    suspend operator fun invoke(entry: MedicationEntry) = repository.updateMedicationEntry(entry)
}
