...
class InsertActivityTypeUseCase(private val repository: ActivityRepository) {
    suspend operator fun invoke(type: ActivityType): Long {
        return repository.insertActivityType(type)
    }
}